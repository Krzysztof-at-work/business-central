...
table 2000000294 "Table Relations Buffer"
{
    Scope = OnPrem;
    TableType = Temporary;
    Access = Internal;
    ...
    begin
        ...
        exit((TableMetadata.TableType = TableMetadata.TableType::Normal) and
              ...
              ((TableMetadata.Scope = TableMetadata.Scope::Cloud) or this.IsOnPrem()) and
    ...
    local procedure IsOnPrem(): Boolean
    begin
        exit(ApplicationIdentifier() = 'NAV');
    end;
