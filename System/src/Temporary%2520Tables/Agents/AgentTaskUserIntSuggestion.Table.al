...
table 2000000279 "Agent Task User Int Suggestion"
{
    ...
    fields
    {
        ...
        /// <summary>
        /// Unique code identifier for the user intervention suggestion used for referencing and management. This code is logged into telemetry.
        /// </summary>
        field(5; "Code"; Code[20])
        {
            Caption = 'Code';
            Tooltip = 'The code defining the user intervention suggestion.';
        }
    }
    ...
    keys
    {
        key(PK; "Summary")
        {
            // NOTE: 'The "Summary" field is not a unique identifier and should not be used as a key. The "Code" field should be used instead.
            // The table will change primary key when consumers have updated their usage to use the "Code" field as the key.
            Clustered = true;
        }
    }
}
