    ...
    layout
    {
        area(Content)
        {
            ...
            repeater(TaskTimeline)
            {
                ...
                field(PrimaryPageExists; Rec."Primary Page Exists")
                {
                    Caption = 'Primary Page Exists';
                    ToolTip = 'Indicates whether the primary page associated with this timeline step exists.';
                }
            }
        }
    }
